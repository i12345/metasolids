...
import { FieldPointType, field_point_new, field_point_type_size } from "../../type.js"
import { FieldPointWithMultiObjectPath, FusingFieldPointVectorWithMultiObjects, PrimitiveFuseMode } from "../fusing.js"
import { FieldPointVectorContainerStatic, FieldPointVectorWithMultiObjRoot, FieldPointVectorDynamic, FieldPointVectorStatic, ItemObjValuesOffsetsKey, FieldPointVectorContainer, isDynamicVector, ItemObjIDsKey, FieldPointVector, FieldPointVectorContainerDynamic } from "../point.js"
import { mat4_from_mat3, mat4_lerp_identity } from "../../../utils/matrix.js"
import { NumberTypedArray, isNumberTypedArray } from "../../../paradigm/arrays/typed-array.js"
...
export class ArithmeticPrimitiveFuseMode<Point extends FieldPointPrimitive = FieldPointPrimitive> implements PrimitiveFuseMode<Point> {
    ...
    fuseSingle<
        ...
        if (this.weights) {            
            ...
            if (points.length === 0)
                return { reducedValue: <Point>field_point_new(type) }
            else {
                if (type === Number) {
                    let result: number
    ...
    fuseVector<
        ...
        if (this.weights !== undefined)
            return this.fuseVector_weighted(elementType, results, points, isMultiObjMapped)
                                ...
                                switch (elementType) {
                                    case Quat: {
                                        ...
                                        for (resultVector_i = 0; resultVector_i < resultVector.length; resultVector_i += 4) {
                                            ...
                                            point.set(
                                                pointVector.get(resultVector_i + 0),
                                                pointVector.get(resultVector_i + 1),
                                                pointVector.get(resultVector_i + 2),
                                                pointVector.get(resultVector_i + 3)
                                            )
                                    ...
                                    case Mat3: {
                                        ...
                                        for (resultVector_i = 0; resultVector_i < resultVector.length; resultVector_i += 9) {
                                            result_data[0] = resultVector.get(resultVector_i + 0)
                                            result_data[1] = resultVector.get(resultVector_i + 1)
                                            result_data[2] = resultVector.get(resultVector_i + 2)
                                            result_data[3] = 0
                                            result_data[4] = resultVector.get(resultVector_i + 3)
                                            result_data[5] = resultVector.get(resultVector_i + 4)
                                            result_data[6] = resultVector.get(resultVector_i + 5)
                                            result_data[7] = 0
                                            result_data[8] = resultVector.get(resultVector_i + 6)
                                            result_data[9] = resultVector.get(resultVector_i + 7)
                                            result_data[10] = resultVector.get(resultVector_i + 8)
                                            result_data[11] = 0
                                            result_data[12] = result_data[13] = result_data[14] = result_data[15] = 0

                                            point_data[0] = resultVector.get(resultVector_i + 0)
                                            point_data[1] = resultVector.get(resultVector_i + 1)
                                            point_data[2] = resultVector.get(resultVector_i + 2)
                                            point_data[3] = 0
                                            point_data[4] = resultVector.get(resultVector_i + 3)
                                            point_data[5] = resultVector.get(resultVector_i + 4)
                                            point_data[6] = resultVector.get(resultVector_i + 5)
                                            point_data[7] = 0
                                            point_data[8] = resultVector.get(resultVector_i + 6)
                                            point_data[9] = resultVector.get(resultVector_i + 7)
                                            point_data[10] = resultVector.get(resultVector_i + 8)
                                            point_data[11] = 0
                                            point_data[12] = point_data[13] = point_data[14] = point_data[15] = 0

                                            result.mul(point)

                                            resultVector.set(resultVector_i + 0, result_data[0])
                                            resultVector.set(resultVector_i + 1, result_data[1])
                                            resultVector.set(resultVector_i + 2, result_data[2])
                                            resultVector.set(resultVector_i + 3, result_data[4])
                                            resultVector.set(resultVector_i + 4, result_data[5])
                                            resultVector.set(resultVector_i + 5, result_data[6])
                                            resultVector.set(resultVector_i + 6, result_data[8])
                                            resultVector.set(resultVector_i + 7, result_data[9])
                                            resultVector.set(resultVector_i + 8, result_data[10])
                                        }
                                        break
                                    }
                                    ...
                                    case Mat4: {
                                        ...
                                        for (resultVector_i = 0; resultVector_i < resultVector.length; resultVector_i += 16) {
                                            ...
                                            for (let j = 0; j < 16; j++)
                                                point.data[j] = pointVector.get(resultVector_i + j)
                                ...
                                switch (elementType) {
                                    case Quat: {
                                        ...
                                        for (resultVector_i = 0; resultVector_i < resultVector.length; resultVector_i += 4) {
                                            ...
                                            point.set(
                                                pointVector[resultVector_i + 0],
                                                pointVector[resultVector_i + 1],
                                                pointVector[resultVector_i + 2],
                                                pointVector[resultVector_i + 3]
                                            )
                                    ...
                                    case Mat3: {
                                        ...
                                        for (resultVector_i = 0; resultVector_i < resultVector.length; resultVector_i += 9) {
                                            ...
                                            point_data[0] = pointVector[resultVector_i + 0]
                                            point_data[1] = pointVector[resultVector_i + 1]
                                            point_data[2] = pointVector[resultVector_i + 2]
                                            point_data[3] = 0
                                            point_data[4] = pointVector[resultVector_i + 3]
                                            point_data[5] = pointVector[resultVector_i + 4]
                                            point_data[6] = pointVector[resultVector_i + 5]
                                            point_data[7] = 0
                                            point_data[8] = pointVector[resultVector_i + 6]
                                            point_data[9] = pointVector[resultVector_i + 7]
                                            point_data[10] = pointVector[resultVector_i + 8]
                                            point_data[11] = 0
                                            point_data[12] = point_data[13] = point_data[14] = point_data[15] = 0
                                    ...
                                    case Mat4: {
                                        ...
                                        for (resultVector_i = 0; resultVector_i < resultVector.length; resultVector_i += 16) {
                                            ...
                                            point.data = <Float32Array><unknown>resultVector.subarray((16 * resultVector_i),  (16 * resultVector_i) + 16)
                            ...
                            case ArithmeticPrimitiveFuseModeOp.divide:
                                switch (elementType) {
                                    ...
                                    case Mat4: {
                                        ...
                                        for (resultVector_i = 0; resultVector_i < resultVector.length; resultVector_i += 16) {
                                            result.data = <Float32Array><unknown>resultVector.subarray((16 * resultVector_i),  (16 * resultVector_i) + 16)
                                            point.data.set(resultVector.subarray((16 * resultVector_i),  (16 * resultVector_i) + 16))
                                            point.invert()
            ...
            if (isMultiObjMappedPoints) {
                if (isDynamicVectorPoint) { // Quat/Matrix multiObj dynamic
                    ...
                    for (const { vector: vectorized, vectorizedRoot } of points) {
                        const pointVector = <FieldPointVectorDynamic<Point>><any>vectorized
                        const pointVectorLength = vectorizedRoot[ItemObjValuesOffsetsKey].length / elementSize
                        const pointWeights = extract<FieldPointVectorDynamic<number>>(vectorizedRoot, this.weights!)
                                            ...
                                            case Quat: {
                                                ...
                                                for (let i = 0; i < pointVectorLength; i++) {
                                                    ...
                                                    if (pointVectorObjOffset_next !== pointVectorObjOffset_prev) {
                                                        do {
                                                            objID = pointObjIDs[pointVectorObjOffset_prev]
                                                            weight = pointWeights.get(pointVectorObjOffset_prev)
                                                            ...
                                                            point.slerp(Quat.IDENTITY, point, weight)
                                                ...
                                                for (let i = 0; i < pointVectorLength; i++) {
                                                    ...
                                                    if (pointVectorObjOffset_next !== pointVectorObjOffset_prev) {
                                                        do {
                                                            ...
                                                            mat4_lerp_identity(point, weight)
                    ...
                    for (const { vector: vectorized, vectorizedRoot } of points) {
                        const pointVector = <FieldPointVectorStatic<Point, FieldPointVectorContainerStatic>><any>vectorized
                        const pointVectorLength = vectorizedRoot[ItemObjValuesOffsetsKey].length / elementSize
                        const pointWeights = extract<FieldPointVectorStatic<number>>(vectorizedRoot, this.weights!)
                                            ...
                                            case Quat: {
                                                ...
                                                for (let i = 0; i < pointVectorLength; i++) {
                                                    ...
                                                    if (pointVectorObjOffset_next !== pointVectorObjOffset_prev) {
                                                        do {
                                                            objID = pointObjIDs[pointVectorObjOffset_prev]
                                                            weight = pointWeights[pointVectorObjOffset_prev]
                                                ...
                                                for (let i = 0; i < pointVectorLength; i++) {
                                                    ...
                                                    if (pointVectorObjOffset_next !== pointVectorObjOffset_prev) {
                                                        do {
                                                            ...
                                                            for (let j = 0; j < 16; j++)
                                                                point.data[j] = pointVector[pointVectorOffset + j]
                                            ...
                                            for (let i = 0; i < pointVectorLength; i++) {
                                                ...
                                                if (pointVectorObjOffset_next !== pointVectorObjOffset_prev) {
                                                    ...
                                                    do {
                                                        ...
                                                        for (let j = 0; j < 16; j++)
                                                            point_data[j] = pointVector[pointVectorOffset + j]
                            ...
                            case ArithmeticPrimitiveFuseModeOp.multiply:
                                switch (elementType) {
                                    case Quat: {
                                        ...
                                        const point = new Quat()
                                        for (resultVector_i = 0; resultVector_i < resultVector.length; resultVector_i += 4) {
                                            weight = pointWeights.get(resultVector_i)
                                    ...
                                    case Mat4: {
                                        ...
                                        const result_data = result.data
                                        const point_data = point.data
                                        let point_data_offset: number
                                        for (resultVector_i = 0; resultVector_i < resultVector.length; resultVector_i += 16) {
                                            weight = pointWeights.get(resultVector_i)

                                            point_data_offset = 16 * resultVector_i
                                            for (let j = 0; j < 16; j++) {
                                                result_data[j] = resultVector.get(point_data_offset)
                                                point_data[j] = pointVector.get(point_data_offset)
                                                point_data_offset++
                                            }
                            ...
                            case ArithmeticPrimitiveFuseModeOp.multiply:
                                switch (elementType) {
                                    case Quat: {
                                        ...
                                        const point = new Quat()
                                        for (resultVector_i = 0; resultVector_i < resultVector.length; resultVector_i += 4) {
                                            weight = pointWeights[resultVector_i]
                                    ...
                                    case Mat4: {
                                        ...
                                        for (resultVector_i = 0; resultVector_i < resultVector.length; resultVector_i += 16) {
                                            ...
                                            point_data_offset = 16 * resultVector_i
                                            result.data = <Float32Array><unknown>resultVector.subarray(point_data_offset, point_data_offset + 16)
                                            
                                            for (let j = 0; j < 16; j++)
                                                point_data[j] = resultVector[point_data_offset++]
                                    ...
                                    for (let i = 0; i < pointVectorLength; i++) {
                                        ...
                                        if (pointVectorObjOffset_next !== pointVectorObjOffset_prev) {
                                            do {
                                                ...
                                                for (componentIndex = 0; componentIndex < elementSize; componentIndex++)
                                                    resultVector.set(resultVectorOffset + componentIndex, resultVector.get(resultVectorOffset + componentIndex) + (weight * pointVector.get(pointVectorOffset++)))
                                            }
                                            while (++pointVectorObjOffset_prev < pointVectorObjOffset_next)
                                    ...
                                    for (let i = 0; i < pointVectorLength; i++) {
                                        ...
                                        if (pointVectorObjOffset_next !== pointVectorObjOffset_prev) {
                                            do {
                                                ...
                                                //TODO: use result = e^sum[reducing i][weight[i] * ln(points[i])]

                                                for (componentIndex = 0; componentIndex < elementSize; componentIndex++)
                                                    resultVector.set(resultVectorOffset + componentIndex, resultVector.get(resultVectorOffset + componentIndex) * Math.pow(pointVector.get(pointVectorOffset++), weight))
                                            }
                                            while (++pointVectorObjOffset_prev < pointVectorObjOffset_next)
                                    ...
                                    for (let i = 0; i < pointVectorLength; i++) {
                                        ...
                                        if (pointVectorObjOffset_next !== pointVectorObjOffset_prev) {
                                            do {
                                                ...
                                                for (componentIndex = 0; componentIndex < elementSize; componentIndex++) {
                                                    weightedComponent = weight * pointVector.get(pointVectorOffset)
                                                    if (resultVector.get(resultVectorOffset + componentIndex) > weightedComponent)
                                                        resultVector.set(resultVectorOffset + componentIndex, weightedComponent)
                                    ...
                                    for (let i = 0; i < pointVectorLength; i++) {
                                        ...
                                        if (pointVectorObjOffset_next !== pointVectorObjOffset_prev) {
                                            do {
                                                ...
                                                for (componentIndex = 0; componentIndex < elementSize; componentIndex++)
                                                    ///@ts-ignore
                                                    resultVector[resultVectorOffset + componentIndex] = resultVector[resultVectorOffset + componentIndex] + (weight * pointVector[pointVectorOffset++])
                                            }
                                            while (++pointVectorObjOffset_prev < pointVectorObjOffset_next)
                                    ...
                                    for (let i = 0; i < pointVectorLength; i++) {
                                        ...
                                        if (pointVectorObjOffset_next !== pointVectorObjOffset_prev) {
                                            do {
                                                ...
                                                for (componentIndex = 0; componentIndex < elementSize; componentIndex++)
                                                    ///@ts-ignore
                                                    resultVector[resultVectorOffset + componentIndex] = resultVector[resultVectorOffset + componentIndex] * Math.pow(pointVector[pointVectorOffset++], weight)
                                            }
                                            while (++pointVectorObjOffset_prev < pointVectorObjOffset_next)
                                    ...
                                    for (let i = 0; i < pointVectorLength; i++) {
                                        ...
                                        if (pointVectorObjOffset_next !== pointVectorObjOffset_prev) {
                                            do {
                                                ...
                                                for (componentIndex = 0; componentIndex < elementSize; componentIndex++) {
                                                    weightedComponent = weight * pointVector[pointVectorOffset]
                                                    if (resultVector[resultVectorOffset + componentIndex] > weightedComponent)
                                                        resultVector[resultVectorOffset + componentIndex] = weightedComponent
                                ...
                                for (let i = 0; i < pointVectorLength; i++) {
                                    ...
                                    if (pointVectorObjOffset_next !== pointVectorObjOffset_prev) {
                                        do {
                                            ...
                                            for (componentIndex = 0; componentIndex < elementSize; componentIndex++)
                                                ///@ts-ignore
                                                resultVector[resultVectorOffset + componentIndex] += weight * pointVector[pointVectorOffset++]
                                        }
                                        while (++pointVectorObjOffset_prev < pointVectorObjOffset_next)
                                ...
                                for (let i = 0; i < pointVectorLength; i++) {
                                    ...
                                    if (pointVectorObjOffset_next !== pointVectorObjOffset_prev) {
                                        do {
                                            ...
                                            for (componentIndex = 0; componentIndex < elementSize; componentIndex++)
                                                ///@ts-ignore
                                                resultVector[resultVectorOffset + componentIndex] *= Math.pow(pointVector[pointVectorOffset++], weight)
                                        }
                                        while (++pointVectorObjOffset_prev < pointVectorObjOffset_next)
            ...
            if (isDynamicVectorPoint) {
                ...
                for (const { vector: vectorized, vectorizedRoot } of points) {
                    ...
                    switch (this.op) {
                        ...
                        case ArithmeticPrimitiveFuseModeOp.add:
                            for (let i = 0; i < resultVector.length; i++)
                                resultVector.set(i, resultVector.get(i) + (pointWeights.get(i) * pointVector.get(i)))
                        ...
                        case ArithmeticPrimitiveFuseModeOp.multiply:
                            for (let i = 0; i < resultVector.length; i++)
                                resultVector.set(i, resultVector.get(i) * (pointVector.get(i) ** pointWeights.get(i)))
                            break
                        ...
                        case ArithmeticPrimitiveFuseModeOp.min: {
                            let weightedComponent: number
                            for (let i = 0; i < resultVector.length; i++) {
                                weightedComponent = pointWeights.get(i) * pointVector.get(i)
                                if (resultVector.get(i) > weightedComponent)
                                    resultVector.set(i, weightedComponent)
                            }
                            break
                        }
                ...
                for (const { vector: vectorized, vectorizedRoot } of points) {
                    ...
                    switch (this.op) {
                        ...
                        case ArithmeticPrimitiveFuseModeOp.add:
                            for (let i = 0; i < resultVector.length; i++)
                                ///@ts-ignore
                                resultVector[i] += pointWeights[i] * pointVector[i]
                            break
                        ...
                        case ArithmeticPrimitiveFuseModeOp.multiply:
                            for (let i = 0; i < resultVector.length; i++)
                                ///@ts-ignore
                                resultVector[i] *= (pointVector[i] ** pointWeights[i])
                        ...
                        case ArithmeticPrimitiveFuseModeOp.min: {
                            let weightedComponent: number
                            for (let i = 0; i < resultVector.length; i++) {
                                weightedComponent = pointWeights[i] * pointVector[i]
                                if (resultVector[i] > weightedComponent)
                                    resultVector[i] = weightedComponent
                            }
                            break
                        }
