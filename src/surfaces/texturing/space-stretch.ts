import { FieldPointVector, FieldPointVectorContainer, FieldPointVectorContainerStatic, FieldPointVectorStatic } from "../../fields/vectorized/index.js"
...
import { MultiObjectsGroupsMapped, MultiObjectsGroupsTemplate, MultiObjectsGroupsTemplateLeaf, MultiObjectsGroupsTemplate_Leaf, groupKinds } from "../../paradigm/trees/index.js"
...
import { Triangles2DMesh, Triangles2DMeshCollider } from "../../fields/triangles-2D-mesh.js"
...
export class SpaceStretchTexture<
    ...
    readonly field: Field<ScalarN<tf.Rank.R2>> = new FieldsField<ScalarN<tf.Rank.R2>>({
